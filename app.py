...
WEEK_DRIVE_IDS = {
    ...
    "第五週 （聽＆說）": {
        ...
        "audio_id_5": "1-z12oqmcz6ODl-vsi_X0Zq_mIkuWkjkW",
        "audio_id_6": "1bPyDmk63np-hix72BxY1p5FHGn5v-fNh",
        "audio_id_7": "1ppiiajo6iRBWgoy8MEFTplyRungeikRD",
        "audio_id_8": "1zrDlceOjq297SB4B3uFgKWz2C8vzGjix",
        "form_url": "https://docs.google.com/forms/d/e/1FAIpQLSeHyWSA6oB4aUd9yMSnYvIu2hVh8g9quY8K8F7CgxkNfs66TQ/viewform?usp=header", 
        "form_url_2": "", 
        "form_url_3": "",
        "form_btn_1_label": "🎯 W5L1聽力-對話理解",
        "form_btn_2_label": "📝 W5L2聽力-對話理解",
        "form_btn_3_label": "🚀 W5L3聽力-對話理解",
    ...
    "第七週 （聽＆說）": {
        ...
        "form_btn_2_label": "",
        "form_btn_3_label": "",
        "instruction_text": "善用「是什麼、為什麼、如何做」的分段方式，把每一段都隱含了「5W原則（人、事、時、地、物/因）」的訣竅。",
    ...
    "第八週 （聽＆說）": {
        ...
        "audio_id_2": "",
        "audio_id_3": "",
        "form_url": "https://docs.google.com/forms/d/e/1FAIpQLSd7UJj-gW7rDdoWTPSOTT7mhcr-4c8En3foQWloLRjV4RbYbA/viewform?usp=header", 
        "form_url_2": "", 
        "form_url_3": "",
        "form_btn_1_label": "🎯 【第八週】對話推論",
        "form_btn_2_label": "",
        "form_btn_3_label": "",
        "instruction_text": "善用「是什麼、為什麼、如何做」的分段方式，把每一段都隱含了「5原則（人、事、時、地、物/因）」的訣竅。",
        "note_title": "💡 口語表達的物理與神經重建：",
        "note_content": "請徹底銷毀腦中『先想中文、再翻族語』的雙層延遲路徑。強迫大腦神經直接將目標意圖綁定阿美語的『動詞焦點』與『格位標記』，依靠肌肉記憶完成聲波釋放，實現無阻力直出。"
    },
    "第九週 （聽＆說）": {
    ...
    if selected_week == "請選擇":
        ...
        if lecture_content and not lecture_content.startswith("⚠️") and not lecture_content.startswith("🚨"):
            expander_tags = [
                ...
                "【第四週線上課程】", "【翻譯實戰練習】",
                "【第五週線上課程】", "【W5L1聽力-對話理解】",
                "【第六週線上課程】", "【第七週線上課程】","【口語表達公式】","【常用轉折語應用】","【課後練習-W7_口語表達_01】",
                "【第八週線上課程】","【口語表達練習技巧】","【第八週表單測驗-對話推論】",
                "【第九週線上課程】","【2分鐘大綱速記】","【語境、語態與時貌：範例～dipot】","【現代公共機構的稱呼】","【W9_2分鐘速記_01】",
            ]
...
with tab3:
    ...
    if selected_week_t3 == "請選擇":
        ...
        if current_week_info.get("form_url"):
            btn_label_1 = current_week_info.get("form_btn_1_label", f"🎯 【{selected_week_t3}】 練習表單01")

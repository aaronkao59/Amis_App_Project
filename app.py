...
WEEK_DRIVE_IDS = {
    ...
    "第六週": {
        "title": "寫作/族語翻譯",
        "file_id": "請在此貼上第六週教材的_FILE_ID", 
        "audio_id": "",
        "audio_id_1": "請在此貼上第六週音檔1的_FILE_ID", 
        "audio_id_2": "請在此貼上第六週音檔2的_FILE_ID", 
        "form_url": "請在此貼上第六週測驗表單_URL", 
        "form_url_2": "", 
        "form_url_3": "",
        "form_btn_1_label": "🎯 【第6週】族語翻譯_PC01",
        "instruction_text": "面對長篇閱讀，請直接拆解句型：優先鎖定句首的「動詞焦點 (Mi-/Ma-/-en)」與對應的「格位標記 (ko/to/no)」。不要急著逐字翻譯，先還原句子的基本結構（VSO 語序）。",
        "note_title": "💡 閱讀與結構拆解攻略：",
        "note_content": "高級認證的長篇文本考驗的是對『語意叢集』的瞬間辨識。請暫時摒除中文 SVO 的思考慣性，遇到複雜長句時，找出核心主詞與修飾子句的界線，利用上下文的邏輯轉折詞來推導未知生詞的語意。"
    }
}
